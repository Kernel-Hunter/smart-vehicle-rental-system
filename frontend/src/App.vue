...
<style scoped>
/* ── Smooth hover for tech stack and team cards ── */
/* Must use :deep to reach inside Vuetify's v-card rendered element */
.v-col :deep(.v-card) {
...
.v-theme--light .v-col :deep(.v-card:hover) {
  transform: translateY(-8px) !important;
  box-shadow: 0 16px 40px rgba(13,148,136,0.2) !important;
}

.v-theme--dark .v-col :deep(.v-card:hover) {
  transform: translateY(-8px) !important;
  box-shadow: 0 16px 40px rgba(45,212,191,0.22) !important;
}
